...
<head>
    ...
    <title>Update Event Planner - EventBloom</title>
...
%>
    ...
    <div class="dashboard">
        ...
        <div class="main-content">
            ...
            <form class="staff-form" action="UpdatePlannerServlet" method="POST" onsubmit="return validateForm()">
                <h2>Update Event Planner</h2>
                ...
                <select id="specialization" name="specialization" required>
                    ...
                    for (String s : specs) {
                    %>
                        <option <%= (specialization != null && s.equals(specialization)) ? "selected" : "" %>><%= s %></option>
                    <% } %>
                </select>
            ...
            %>
                <script>
                    Swal.fire({
                        icon: 'success',
                        title: 'Event Planner Updated Successfully!',
            ...
            %>
                <script>
                    Swal.fire({
                        icon: 'error',
                        title: 'Failed to Update Event Planner!',
