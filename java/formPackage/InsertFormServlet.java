...
public class InsertFormServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = FormController.insertdata(name, email, phone, ePackage, ePlanner, eDate, eLocation, numberOfGuests, specialRequirements);
		
		if(isTrue == true) {
			
			String alertMassage = "Form submitted Successful";
